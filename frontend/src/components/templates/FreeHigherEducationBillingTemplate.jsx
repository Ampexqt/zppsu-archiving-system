export default function FreeHigherEducationBillingTemplate({ data }) {
  return (
    <div style={{ padding: "20px", background: "#fff" }}>
      ...
      >
        MASTERLIST OF RECORDS FOR FREE HIGHER EDUCATION BILLING DETAILS
      </h2>
      ...
      >
        <thead>
          <tr>
            ...
            <th style={styles.header}>SEMESTER</th>
