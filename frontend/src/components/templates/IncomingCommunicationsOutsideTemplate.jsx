export default function IncomingCommunicationsOutsideTemplate({ data }) {
  return (
    <div style={{ padding: "20px", backgroundColor: "white" }}>
      ...
      >
        ZPPSU MASTERLIST OF RECORDS - INCOMING COMMUNICATIONS OUTSIDE ZC
        PERIMETER
      </h2>
      ...
      >
        <thead>
          <tr>
            ...
            <th style={styles.header}>AGENCY</th>
        ...
        <tbody>
          <tr>
            ...
            <td style={styles.cell}>{data.agency}</td>
