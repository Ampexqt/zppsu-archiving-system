export default function StudentsAPEXTemplate({ data }) {
  return (
    <div style={{ padding: "20px", background: "#fff" }}>
      ...
      >
        MASTERLIST OF RECORDS FOR STUDENTS APPRENTICESHIP AND EXPO (APEX)
      </h2>
      ...
      >
        <thead>
          <tr>
            ...
            <th style={styles.header}>COURSE AND YEAR</th>
