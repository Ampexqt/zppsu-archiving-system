export default function StudentsInOffCampusTeachingTemplate({ data }) {
  return (
    <div style={{ padding: "20px", background: "#fff" }}>
      ...
      >
        MASTERLIST OF RECORDS FOR STUDENTS IN/OFF CAMPUS TEACHING
      </h2>
      ...
      >
        <thead>
          <tr>
            ...
            <th style={styles.header}>ASSIGNED SCHOOL</th>
