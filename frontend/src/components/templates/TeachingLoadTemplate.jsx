export default function TeachingLoadTemplate({ data }) {
  return (
    <div style={{ padding: "20px", background: "#fff" }}>
      ...
      >
        MASTERLIST OF RECORDS FOR TEACHING LOAD
      </h2>
      ...
      >
        <thead>
          <tr>
            ...
            <th style={styles.header}>NAME OF FACULTY</th>
            <th style={styles.header}>ACADEMIC YEAR</th>
