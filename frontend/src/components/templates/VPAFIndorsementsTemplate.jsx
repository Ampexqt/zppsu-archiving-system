export default function VPAFIndorsementsTemplate({ data }) {
  return (
    <div style={{ padding: "20px", background: "#fff" }}>
      ...
      >
        MASTERLIST OF RECORDS FOR VPAF INDORSEMENTS
      </h2>
      ...
      >
        <thead>
          <tr>
            ...
            <th style={styles.header}>CONCERNED PERSONNEL</th>
        ...
        <tbody>
          <tr>
            ...
            <td style={styles.cell}>{data.concerned_personnel}</td>
