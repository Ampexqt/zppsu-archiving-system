...
function CustomDropdown({ value, onChange, children, ...props }) {
  ...
  if (props.name === "months") {
    return (
      ...
      >
        <SelectTrigger className="h-7 w-fit pr-1.5 font-medium border-none shadow-none focus:ring-0">
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger
        type="button"
        className="flex items-center h-7 w-fit px-2 font-medium hover:bg-muted rounded-md"
      >
        {selected?.label}
